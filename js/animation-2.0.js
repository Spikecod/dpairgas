...
function t_animate__checkMobile(t) {
    return Array.prototype.filter.call(t, function (t) {
        var e,
            a = t.closest(".t396__elem"),
            a = a ? a.getAttribute("data-animate-mobile") : null;
        return t.classList.contains("r")
            ...
            !1)
            : !!a || (t.classList.remove("t-animate"), !1);
    });
}
...
function t_animate__checkAnimationAvailability() {
    ...
    return (
        (!/Bot/i.test(navigator.userAgent) && "yes" !== e && !t_animate__checkIE() && "edit" !== t) ||
...
function t_animate__generateStyles() {
    if (!!document.querySelector(".t396")) {
        ...
        for (a = 0; a < t.length; a++)
            (n = t_animate__getMediaQuery(t, a)).isContinue ||
                (e += n.text + "#allrecords .t396 .t-animate[data-animate-style-res-" + n.minRes + '="fadeinright"] {-webkit-transform: translate(-100px, 0);transform: translate(-100px, 0);}}');
    ...
    return (
        Array.prototype.forEach.call(t, function (t) {
            t.classList.contains("t396__artboard") &&
                ((t = (t = (t = (t = t.getAttribute("data-artboard-screens")) ? t.split(",") : [1200, 960, 640, 480, 320]).map(function (t) {
...
function t_animate__getMediaQuery(t, e) {
    var a = "",
        ...
        o = e === t.length - 1,
        e = e === t.length - 2;
    return o ? (n = !0) : (a += e ? "@media screen and (max-width: " + r + "px) {" : "@media screen and (min-width: " + i + "px) and (max-width: " + r + "px) {"), { text: a, isContinue: n, minRes: i };
}
...
function t_animate__startAnimation() {
    ...
    (o = Array.prototype.filter.call(o, function (t) {
        ...
        window.innerWidth < 1200 && ((i = t_animate__checkMobile(i)), (r = t_animate__checkMobile(r)), (o = t_animate__checkMobile(o))),
                                ...
                                new IntersectionObserver(function (t, n) {
                                    t.forEach(function (t) {
                                        ...
                                        !a.demandTransform && a.style.transform
                                            ? ((a.demandTransform = a.style.transform), (a.style.transform = "unset"))
                                              : ((e = window.getComputedStyle(a).transform), a.style.transform || "none" === e || ((a.demandTransform = e), (a.style.transform = "unset"))),
                                              t.isIntersecting &&
                                                  ...
                                                  a.demandTransform && "unset" === a.style.transform && ((a.style.transform = a.demandTransform), delete a.demandTransform),
                                                  setTimeout(function () {
                ...
                a &&
                    a.addEventListener(
                        ...
                        t_throttle(function () {
                            ...
                            ((a.classList.contains("t-animate") && "yes" === a.getAttribute("data-animate-chain")) || a.querySelector(".t-animate[data-animate-chain=yes]")) &&
    ...
    return (
        Array.prototype.filter.call(t, function (t) {
            ...
            return t.curTopOffset < e
                ? (t.classList.remove("t-animate_wait"), t_animate__removeNoHoverClassFromBtns(t), t.classList.add("t-animate_started"), "animatednumber" === t_animate__getAttrByResBase(t, "style") && t_animate__animateNumbers(t), !0)
    ...
    Array.prototype.forEach.call(t, function (t) {
        ...
        Array.prototype.forEach.call(i, function (t) {
            ...
            t.querySelectorAll('div[data-customstyle="yes"]').length
                ? ((e = (i = t.querySelector('div[data-customstyle="yes"]')) ? i.innerHTML : ""),
...
function t_animate__animateNumbers(e) {
    ...
    c[0] &&
        ...
        (s = setInterval(function () {
            var t;
            (i += n / 108),
                (o = f ? (Math.round(i) / r).toFixed(d) + "" : Math.floor(i) + ""),
...
function t_animate__setAnimELemsState(t, n, i) {
    t.forEach(function (t) {
        ...
        t_animate__setCustomAnimSettings(t, e, i),
            e < a && !t.closest(".t1093") && (t_animate__removeNoHoverClassFromBtns(t), t.classList.add("t-animate_started"), "animatednumber" === t_animate__getAttrByResBase(t, "style") && t_animate__animateNumbers(t)),
    ...
    t.forEach(function (a) {
        ...
        t_animate__assignGroupDelay(a, e),
            Array.prototype.forEach.call(t, function (t) {
                ...
                if ((t.classList.contains("t-animate_no-hover") && e && t.classList.remove("t-animate_no-hover"), n <= i - 100))
                    return t_animate__saveSectionHeaderStartTime(a), t.classList.remove("t-animate"), t.classList.remove("t-animate_no-hover"), !(t.style.transitionDelay = "");
                n < r &&
                    i - 100 < n &&
                    (t_animate__makeSectionButtonWait(a), t.classList.contains(".t-animate__btn-wait-chain") || (t_animate__removeNoHoverClassFromBtns(t), e ? t.classList.add("t-animate_wait") : t.classList.add("t-animate_started"))),
...
function t_animate__assignOrderedElemsDelay(t, e) {
    ...
    e.length &&
        ...
        (e.length || n.length || i.length || r.length || o.length || s.length || l.length) &&
            m.length &&
            ((a += +t_animate__getAttrByResBase(m[0], "delay")),
            Array.prototype.forEach.call(m, function (t) {
                t.style.transitionDelay = a + "s";
            })),
        (e.length || n.length || i.length || r.length || o.length || s.length || l.length || m.length) &&
            t.length &&
...
function t_animate__assignChainDelay(a, n, i) {
    ...
    l.length &&
        ...
        Array.prototype.forEach.call(l, function (e) {
            ...
            t < n
                ? (t !== o && (e.classList.add("t-animate__chain_first-in-row"), (o = t)),
                  (t = 0.16 * m + s),
...
function t_animate__removeInlineAnimStyles() {
    ...
    window.innerWidth < 980 &&
        ((t = document.querySelectorAll(".t396__elem.t-animate:not(.t-animate_wait)")),
        Array.prototype.forEach.call(t, function (t) {
...
function t_animate__getCurBlockSectionHeadDelay(t) {
    var e = 0;
    return t.querySelectorAll(".t-section__title.t-animate").length && (e += 0.16), t.querySelectorAll(".t-section__descr.t-animate").length && (e += 0.16), e;
}
...
function t_animate__checkSectionButtonAnimation(t, e) {
    ...
    t.length &&
        Array.prototype.forEach.call(t, function (t) {
            (t.style.transitionDelay = e + 0.16 + "s"), t_animate__removeNoHoverClassFromBtns(t), t.classList.remove("t-animate__btn-wait-chain"), t.classList.add("t-animate_started");
        });
}
